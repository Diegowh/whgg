...
class ApiController:
    ...
    def get_champion_masteries(self, summoner_id: str):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "champion-mastery/v4/champion-masteries/by-summoner/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_champion_masteries_by_champion_id(self, summoner_id, champion_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "champion-mastery/v4/champion-masteries/by-summoner/{summoner_id}/by-champion/{champion_id}").format(server=self._platform, summonerId=summoner_id, championId=champion_id))
    ...
    def get_champion_masteries_score(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "champion-mastery/v4/scores/by-summoner/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_league_by_summoner(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/entries/by-summoner/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_league_by_id(self, league_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/leagues/{league_id}").format(server=self._platform, league_id=league_id))
    ...
    def get_league_pages(self, queue="RANKED_SOLO_5X5", tier="DIAMOND", division="I", page=1):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/entries/{queue}/{tier}/{division}?page={page}").format(server=self._platform, queue=queue, tier=tier, division=division, page=page))
    ...
    def get_challenger_league(self, queue="RANKED_SOLO_5x5"):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/challengerleagues/by-queue/{queue}").format(server=self._platform, queue=queue))
    ...
    def get_grandmaster_league(self, queue="RANKED_SOLO_5x5"):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/grandmasterleagues/by-queue/{queue}").format(server=self._platform, queue=queue))
    ...
    def get_master_league(self, queue="RANKED_SOLO_5x5"):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "league/v4/masterleagues/by-queue/{queue}").format(server=self._platform, queue=queue))
    ...
    def get_match(self, match_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "match/v5/matches/{match_id}").format(server=self._region, match_id=match_id))
    ...
    def get_timeline(self, match_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "match/v5/matches/{match_id}/timeline").format(server=self._region, match_id=match_id))
    ...
    def get_matchlist(self, puuid, params=None):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "match/v5/matches/by-puuid/{puuid}/ids{params}").format(server=self._region, puuid=puuid, params = utils.url_params(params)))
    ...
    def get_current_game(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "spectator/v4/active-games/by-summoner/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_summoner(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "summoner/v4/summoners/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_summoner_by_account_id(self, account_id):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "summoner/v4/summoners/by-account/{account_id}").format(server=self._platform, account_id=account_id))
    ...
    def get_summoner_by_name(self, summoner_name):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "summoner/v4/summoners/by-name/{summoner_name}").format(server=self._platform, summoner_name=summoner_name))
    ...
    def get_summoner_by_puuid(self, puuid):
        ...
        """
        return self.fetch((self.BASE_URL_LOL + "summoner/v4/summoners/by-puuid/{puuid}").format(server=self._platform, puuid=puuid))
    ...
    def get_tft_league_by_id(self, league_id):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "league/v1/leagues/{league_id}").format(server=self._platform, league_id=league_id))
    ...
    def get_tft_league_pages(self,  tier="DIAMOND", division="I", page=1):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "league/v1/entries/{tier}/{division}?page={page}").format(server=self._platform, tier=tier, division=division, page=page))
    ...
    def get_tft_league_position(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "league/v1/entries/by-summoner/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_tft_match(self, match_id):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "match/v1/matches/{match_id}").format(server=self._region, match_id=match_id))
    ...
    def get_tft_matchlist(self, puuid, params=None):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "match/v1/matches/by-puuid/{puuid}/ids{params}").format(server=self._region, puuid=puuid, params = utils.url_params(params)))
    ...
    def get_tft_summoner(self, summoner_id):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "summoner/v1/summoners/{summoner_id}").format(server=self._platform, summoner_id=summoner_id))
    ...
    def get_tft_summoner_by_account_id(self, account_id):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "summoner/v1/summoners/by-account/{account_id}").format(server=self._platform, account_id=account_id))
    ...
    def get_tft_summoner_by_puuid(self, puuid):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "summoner/v1/summoners/by-puuid/{puuid}").format(server=self._platform, puuid=puuid))
    ...
    def get_tft_summoner_by_name(self, summoner_name):
        ...
        """
        return self.fetch((self.BASE_URL_TFT + "summoner/v1/summoners/by-name/{summoner_name}").format(server=self._platform, summoner_name=summoner_name))
    ...
    def get_account_by_puuid(self, puuid):
        ...
        """
        return self.fetch((self.BASE_URL_RIOT + "account/v1/accounts/by-puuid/{puuid}").format(server=self._region, puuid=puuid))
    ...
    def get_account_by_riot_id(self, game_name, tag_line):
        ...
        """
        return self.fetch((self.BASE_URL_RIOT + "account/v1/accounts/by-riot-id/{game_name}/{tag_line}").format(server=self._region, game_name=game_name, tag_line=tag_line))
    ...
    def get_active_shards(self, puuid, game):
        ...
        """
        return self.fetch((self.BASE_URL_RIOT + "account/v1/active-shards/by-game/{game}/by-puuid/{puuid}").format(server=self._region, game=game, puuid=puuid))
    ...
    def get_valorant_content(self, locale=None):
        ...
        """
        return self.fetch((self.BASE_URL_VAL + "content/v1/contents{locale}").format(server=self._region, locale="?locale="+locale if locale is not None else ""))
    ...
    def get_valorant_match(self, match_id):
        ...
        """
        return self.fetch((self.BASE_URL_VAL + "match/v1/matches/{match_id}").format(server=self._region, match_id=match_id))
    ...
    def get_valorant_matchlist(self, puuid):
        ...
        """
        return self.fetch((self.BASE_URL_VAL + "match/v1/matchlists/by-puuid/{puuid}").format(server=self._region, puuid=puuid))
    ...
    def get_valorant_recent_matches(self, queue):
        ...
        """
        return self.fetch((self.BASE_URL_VAL + "match/v1/recent-matches/by-queue/{queue}").format(server=self._region, queue=queue))
    ...
    def get_valorant_leaderboard(self, act_id, size=200, start_index=0):
        ...
        """
        return self.fetch((self.BASE_URL_VAL + "ranked/v1/leaderboards/by-act/{act_id}?size={}size&startIndex={start_index}").format(server=self._region, act_id=act_id, size=size, start_index=start_index))